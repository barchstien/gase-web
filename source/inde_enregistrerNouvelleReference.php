				...
				else
				{
					...
					else
					{
						if(is_numeric($prix))
						{
							...
							EnregistrerNouvelleReference($designation, $fournisseur, $categorie, $prix, $tva, $vrac, $codeFournisseur, $commentaire, $visible);
							echo 'Nouvelle reference ' . $designation . ' enregistree.';
						}
						else
						{
